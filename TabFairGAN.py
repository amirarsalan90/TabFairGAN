...
with_fairness.add_argument("--df_name", help="Reference dataframe", type=str, required=True)
#with_fairness.add_argument("fairness", help="With or without fairness enforcement", type=str)
with_fairness.add_argument("--S", help="Protected attribute", type=str, required=True)
with_fairness.add_argument("--Y", help="Label (decision)", type=str, required=True)
with_fairness.add_argument("--underprivileged_value", help="Value for underpriviledged group", type=str, required=True)
with_fairness.add_argument("--desirable_value", help="Desired label (decision)", type=str, required=True)
with_fairness.add_argument("--num_epochs", help="Total number of epochs", type=int, required=True)
with_fairness.add_argument("--batch_size", help="the batch size", type=int, required=True)
with_fairness.add_argument("--num_fair_epochs", help="number of fair training epochs", type=int, required=True)
with_fairness.add_argument("--lambda_val", help="lambda parameter", type=float, required=True)
with_fairness.add_argument("--fake_name", help="name of the produced csv file", type=str, required=True)
with_fairness.add_argument("--size_of_fake_data", help="how many data records to generate", type=int, required=True)


no_fairness.add_argument("--df_name", help="Reference dataframe", type=str, required=True)
no_fairness.add_argument("--num_epochs", help="Total number of epochs", type=int, required=True)
no_fairness.add_argument("--batch_size", help="the batch size", type=int, required=True)
no_fairness.add_argument("--fake_name", help="name of the produced csv file", type=str, required=True)
no_fairness.add_argument("--size_of_fake_data", help="how many data records to generate", type=int, required=True)
